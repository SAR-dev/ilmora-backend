...
migrate((app) => {
  ...
  // remove field
  collection.fields.removeById("_clone_kRMs")

  // remove field
  collection.fields.removeById("_clone_LcOL")

  // remove field
  collection.fields.removeById("_clone_Cxpm")

  // remove field
  collection.fields.removeById("_clone_1IN2")

  // remove field
  collection.fields.removeById("_clone_hlhy")

  // remove field
  collection.fields.removeById("_clone_mD70")

  // remove field
  collection.fields.removeById("_clone_3BXw")

  // remove field
  collection.fields.removeById("_clone_fnoC")

  // remove field
  collection.fields.removeById("_clone_mvN9")

  // remove field
  collection.fields.removeById("_clone_O3J4")
