...
migrate((app) => {
  ...
  // remove field
  collection.fields.removeById("_clone_gRXx")

  // remove field
  collection.fields.removeById("_clone_wqHq")

  // remove field
  collection.fields.removeById("_clone_NkbP")

  // remove field
  collection.fields.removeById("_clone_P0tD")

  // remove field
  collection.fields.removeById("_clone_35KM")

  // remove field
  collection.fields.removeById("_clone_dgDI")

  // remove field
  collection.fields.removeById("_clone_02lA")

  // remove field
  collection.fields.removeById("_clone_rljl")

  // remove field
  collection.fields.removeById("_clone_ID7a")

  // remove field
  collection.fields.removeById("_clone_FaK2")
